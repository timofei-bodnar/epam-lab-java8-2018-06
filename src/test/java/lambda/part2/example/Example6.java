...
public class Example6 {
    ...
    public void suppliers() {
        ...
        if (strSupplier.get() == strSupplier.get()) {
            System.out.println("equals by reference");
        }
    ...
    public void predicates() {
        ...
        assertFalse(emptyChecker.test("1"));
        ...
        assertTrue(containsInValues.test("B"));
        assertFalse(containsInValues.test("D"));
