...
@SuppressWarnings({"Guava", "Convert2Lambda", "Anonymous2MethodRef", "unused"})
public class Example1 {

    @Test
    public void sortPersonsByLastNameUsingArraysSortUsingLocalComparator() {
    ...
    @Test
    public void sortPersonsByLastNameUsingArraysSortUsingAnonymousComparator() {
        Person[] persons = getPersons();
