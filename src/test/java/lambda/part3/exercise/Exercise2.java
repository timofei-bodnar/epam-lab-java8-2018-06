...
public class Exercise2 {
    ...
    public void mapEmployeesToLengthOfTheirFullNamesUsingMapHelper() {
        ...
        // TODO                          .getMapped();
        List<Integer> lengths = new MapHelper<>(employees).map(Employee::getPerson)
    ...
    public void mapEmployeesToCodesOfLetterTheirPositionsUsingMapHelper() {
        ...
        // TODO                        .getMapped();
        Function<String, List<Character>> stringToCharacterArrayFunction = s -> {
        ...
        List<Integer> codes = new MapHelper<>(employees).flatMap(Employee::getJobHistory)
                                                        .map(JobHistoryEntry::getPosition)
                                                        .flatMap(stringToCharacterArrayFunction)
                                                        .map(c -> (int) c)
                                                        .getMapped();
