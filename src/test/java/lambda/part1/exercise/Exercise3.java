...
public class Exercise3 {
    ...
    public void sortPersonsByLastNameThenFirstNameUsingArraysSortExpressionLambda() {
        ...
        Arrays.sort(persons, (left, right) -> left.getLastName().equals(right.getLastName()) ?
    ...
    public void findFirstWithAge30UsingGuavaPredicateLambda() {
        ...
        Person person = FluentIterable.from(persons).firstMatch(person1 -> person1.getAge() == 30)
            .orNull();
